...
# test 2
my $ipv4 = '1.2.3.4';
my $revip = reverse-dotted-net($ipv4);
...
ok is-ipv4($ipv4-good), 'is good ipv4 test';
nok is-ipv4($ipv4-bad), 'is bad ipv4 test';

# test 6, 7
my $ipv6-good = '12:23:3:5';
my $ipv6-bad  = '12.23.3:5';
ok is-ipv6($ipv6-good), 'is good ipv6 test';
nok is-ipv6($ipv6-bad), 'is bad ipv6 test';
